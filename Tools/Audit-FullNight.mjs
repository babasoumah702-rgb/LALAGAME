...
writeFileSync(join(project,'Verification/fullnight-package-audit.json'),JSON.stringify(report,null,2));console.log(JSON.stringify(report));if(issues.length)process.exitCode=1;
